...
## Role
Test each scenario's equity_impact field: who is actually reached, who is left out, and where could the scenario be equity-negative?
...
# Topic directives: equity_checker (rural-school-closures)
...
- [round-02] DIRECTIVE:critic_fix_severity — For every objection add a line 'Severity: high|medium|low' and a line 'Suggested revision: <concrete fix>'.
