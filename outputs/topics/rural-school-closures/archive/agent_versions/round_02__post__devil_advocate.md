...
## Role
Attack each scenario's load-bearing claim; find the assumption whose failure collapses the scenario.
...
# Topic directives: devil_advocate (rural-school-closures)
