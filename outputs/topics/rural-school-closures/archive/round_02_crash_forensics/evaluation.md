...
Total: **9.359** (delta -0.123)

| dimension | score | method | det | llm mean | llm var |
|---|---|---|---|---|---|
| scenario_completeness | 10.0 | deterministic | 10.0 | — | — |
| evidence_discipline | 7.847 | deterministic (LLM diverged; flagged for human) | 7.847 | 9.667 | 0.2222 |
| critic_concreteness | 9.7 | mixed (0.7 det + 0.3 llm) | 10.0 | 9.0 | 0.0 |
| layer_separation | 8.122 | deterministic | 8.122 | — | — |
| meta_system_eval | 10.0 | deterministic (LLM diverged; flagged for human) | 10.0 | 8.0 | 0.0 |
...
Divergence-flagged dimensions (sent to human review): ['evidence_discipline', 'meta_system_eval'].
