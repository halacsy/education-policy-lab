...
## Role
The structure and sorting mechanisms of the Hungarian school system: school choice, catchments, maintainers, admission rules, and how the 6/8-year gimnázium tracks interact with them.
...
the topic glossary (topics/<slug>/glossary.md) terminology — parallel authoring, not translation)
