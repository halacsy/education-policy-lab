...
Severity: high
Suggested revision: Add the retraining-throughput audit as a gate before the year-4 legislative step.
...
Severity: medium
Suggested revision: Assign the mixed-cohort timetable problem to district centres in step 3 with a named deliverable.
