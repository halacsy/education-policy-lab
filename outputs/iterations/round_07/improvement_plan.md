...
## What got better?
- Total 9.478 → 9.005 (delta -0.473).

## What is still weak?
- Weakest dimension: **evidence_discipline** (6.304); strongest: scenario_completeness (10.0).

## Which agent failed? Which workflow step failed?
- Steps degraded to deterministic mock fallback: translate_ledger, translator_brief — these agents' prompts/validators are the weakest links.
...
- **layer_tighten** targeting weakest dimension *layer_separation* (score 6.833).
