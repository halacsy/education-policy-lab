...
## What got better?
- Total 9.478 → 8.936 (delta -0.542).

## What is still weak?
- Weakest dimension: **evidence_discipline** (6.311); strongest: scenario_completeness (10.0).

## Which agent failed? Which workflow step failed?
- Steps degraded to deterministic mock fallback: translate_ledger — these agents' prompts/validators are the weakest links.
...
- **layer_tighten** targeting weakest dimension *layer_separation* (score 7.278).
