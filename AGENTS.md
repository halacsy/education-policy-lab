# AGENTS.md — Education Policy Lab

Working notes for Codex sessions. The owner works in Hungarian; write
...
- Backends: default = API keys. `ANTHROPIC_BACKEND=Codex` → `Codex -p`
...
- Codex CLI backend runs on the owner's Codex subscription — this is
...
- **Branch `run/live-2026-07-08-Codex-gen`**: round 6 live run (Codex
  ...
  ANTHROPIC_BACKEND=Codex GOOGLE_MODEL=
