...
# ---------------------------------------------------------------------------
# Societal-discourse layer (D-29): curated voice pack for the mock path.
# Voices REPRESENT interests/values; every position carries an epistemic
# label. Named actors' documented stances come from docs/research/
# 2026-07-07-stakeholder-programs.md (primary sources linked there).
# ---------------------------------------------------------------------------
...
DISCOURSE_VOICES = {
    ...
    "ckp_tanitanek": dict(
        ...
        source=_KK,
        values="Kockás könyv comprehensive-school programme; Tanítanék 2026 package (workload, autonomy)",
        reactions={
            "S1": _rx("conditional", "value_modeled",
                      "A fairer gate on the same building is progress, but our documented goal is to need no gate before 14 at all.",
                      "A méltányosabb kapu ugyanazon az épületen előrelépés, de dokumentált célunk, hogy 14 éves kor előtt ne kelljen kapu egyáltalán.",
            ...
            "S2": _rx("support", "documented",
                      "The Kockás könyv proposes exactly this: transferring the 6/8-year forms into the comprehensive model gradually, with broad social consensus.",
                      "A Kockás könyv pontosan ezt javasolja: a hat- és nyolcosztályos formák fokozatos átvezetését a komprehenzív modellbe, széles társadalmi egyetértéssel.",
                      ...
                      source=_KK),
            "S3": _rx("support", "documented",
                      "Our programme calls for unified general education as long as possible — at least 10 years — because the 6/8 forms are 'a tool of elite social separation'.",
                      "Programunk minél hosszabb — legalább 10 évfolyamos — egységes képzést kér, mert a 6/8 osztályos formák 'az elit társadalmi elkülönülésének eszközei'.",
                      ...
                      source=_KK),
            "S4": _rx("conditional", "value_modeled",
                      "We demand stronger general schools too — but as the floor of structural reform, not its substitute.",
                      "Mi is erősebb általános iskolát követelünk — de a szerkezeti reform alapjaként, nem helyette.",
    ...
    "pdsz": dict(
        ...
        source=_PDSZ_SRC,
        values="PDSZ Program 2024: structure only via 'professional reconsideration'; wages, workload, strike rights first",
        reactions={
            "S1": _rx("support", "documented",
                      "Our stated 2026 position: if the tracks continue, the admission system must be corrected and segregation actively reduced.",
                      "Kimondott 2026-os álláspontunk: ha a képzések működnek tovább, a felvételi rendszert korrigálni kell és a szegregációt aktívan csökkenteni.",
                      "Correction designed with the profession, not imposed on it.",
                      "A korrekció a szakmával együtt készüljön, ne felülről érkezzen.",
                      source=_PDSZ_SRC),
            "S2": _rx("oppose", "documented",
                      "We argued for keeping the tracks while fixing their access — phase-down was the other union's position, not ours.",
                      "Mi a képzések megtartása és hozzáférésük javítása mellett érveltünk — a kivezetés a másik szakszervezet álláspontja volt, nem a miénk.",
                      ...
                      source=_PDSZ_SRC),
            "S3": _rx("oppose", "documented",
                      "Our program asks only for professional reconsideration of the structure; wholesale restructuring amid unresolved pay and workload disputes is not our demand.",
                      "Programunk csak az iskolaszerkezet szakmai újragondolását kéri; a teljes átszervezés rendezetlen bér- és terhelésviták közepette nem a mi követelésünk.",
                      ...
                      source=_PDSZ_SRC),
            "S4": _rx("support", "value_modeled",
                      "Priority funding for disadvantaged schools and lower workloads are literally in our programme.",
                      "A hátrányos helyzetű iskolák kiemelt támogatása és a terheléscsökkentés szó szerint benne van a programunkban.",
        ...
        response=dict(
            cluster="A2",
            en="We accept the sorting evidence; our documented remedy is admission correction and desegregation within the structure — evidence of harm does not by itself pick the remedy.",
            hu="Elfogadjuk a szelekciós bizonyítékokat; dokumentált gyógymódunk a felvételi korrekciója és a deszegregáció a szerkezeten belül — a kár bizonyítéka önmagában nem választ gyógymódot.",
            outcome="maintain")),
    "tisza_kormany": dict(
        kind="named",
        ...
        frame=dict(en="child-centred, data-driven, partnership-based reform (the minister's three principles)",
                   hu="gyermekközpontú, adatvezérelt, partnerségi reform (a miniszter három elve)"),
        source=_TISZA_SRC,
        values="2026 program: early selection named as problem, no structural commitment; consultation-first governing style",
        reactions={
            "S1": _rx("support", "documented",
                      "The minister has said it publicly: the admission system will be reviewed — the tracks' advantage is selection, not value-added.",
                      "A miniszter nyilvánosan kimondta: a felvételi rendszer felülvizsgálata jön — a képzések előnye szelekció, nem hozzáadott érték.",
                      "Review conclusions must survive the social consultation we promised.",
                      "A felülvizsgálat következtetéseinek ki kell állniuk az ígért társadalmi egyeztetést.",
                      source=_TISZA_SRC),
            "S2": _rx("conditional", "value_modeled",
                      "The program names early selection a problem but commits to no structure; a negotiated, gradual reduction could emerge from consultation.",
                      "A program problémának nevezi a korai szelekciót, de szerkezetet nem vállal; az egyeztetésből kinőhet egy kialkudott, fokozatos szűkítés.",
                      "Only with cross-party durability — we will not repeat the Polish reversal.",
                      "Csak pártokon átívelő tartóssággal — a lengyel visszafordítást nem ismételjük meg.",
                      basis="program diagnosis + consultation-first method"),
            "S3": _rx("oppose", "documented",
                      "The minister has explicitly ruled out abolishing the 6/8-year gimnázium in this term; the fight would consume the whole reform agenda.",
                      "A miniszter kifejezetten kizárta a hat- és nyolcosztályos gimnázium megszüntetését ebben a ciklusban; a küzdelem felemésztené a teljes reform-napirendet.",
                      "A broad, measured consultation could reopen this in a later term.",
                      "Széles, higgadt egyeztetés későbbi ciklusban újranyithatja.",
                      source=_TISZA_SRC),
            "S4": _rx("support", "value_modeled",
                      "Mandatory equity minimums, an equity-based school ranking and targeted support are in the program — this scenario is largely our own chapter.",
                      "A kötelező esélyteremtő minimumok, az esélyteremtési rangsor és a célzott támogatás benne van a programban — ez a forgatókönyv nagyrészt a saját fejezetünk.",
        ...
        response=dict(
            cluster="A10",
            en="The masking risk is fair; that is why the program pairs compensation with a published equity ranking — if the gap does not close, the data will say so and policy must answer.",
            hu="A elfedési kockázat jogos felvetés; ezért kapcsolja a program a kompenzációt nyilvános esélyteremtési rangsorhoz — ha a szakadék nem záródik, az adat kimondja, és a politikának válaszolnia kell.",
            outcome="revise")),
    "egyensuly_intezet": dict(
        kind="named",
        ...
        source=_EI_SRC,
        values="2021 proposal: uniformly 8-year primary, no performance-based selection during it",
        reactions={
            "S1": _rx("conditional", "value_modeled",
                      "A fairer gate reduces harm but our proposal removes the gate: selection at 10 or 12 has no demonstrated benefit to justify keeping it in any form.",
                      "A méltányosabb kapu csökkenti a kárt, de a javaslatunk magát a kaput szünteti meg: a 10-12 éves kori szelekciónak nincs kimutatott haszna, ami bármilyen formáját igazolná.",
            ...
            "S2": _rx("support", "documented",
                      "A gradual phase-down moves toward our documented proposal: a uniformly 8-year primary stage with no selective exit ramps.",
                      "A fokozatos leépítés a dokumentált javaslatunk felé visz: egységesen 8 évfolyamos alapfok, szelektív kijáratok nélkül.",
                      ...
                      source=_EI_SRC),
            "S3": _rx("support", "documented",
                      "This is our published position: research shows early selection yields no gains in later outcomes while reproducing poverty (Gurzó-Horn).",
                      "Ez a publikált álláspontunk: a kutatások szerint a korai szelekció nem javítja a későbbi kimeneteket, miközben újratermeli a szegénységet (Gurzó-Horn).",
                      "Pair with our proposed incentives: reward heterogeneous intake in school evaluation.",
                      "A javasolt ösztönzőinkkel együtt: a heterogén összetétel jutalmazása az intézményértékelésben.",
                      source=_EI_SRC),
            "S4": _rx("conditional", "value_modeled",
                      "We proposed standards and targeted support too — but as complements; compensation alone leaves the selection machine running.",
                      "Mi is javasoltunk sztenderdeket és célzott támogatást — de kiegészítésként; a kompenzáció önmagában járva hagyja a szelekciós gépezetet.",
        ...
        response=dict(
            cluster="A8",
            en="Correct: Finland bundled structure with teacher policy — which is an argument for bundling, not for keeping selection; our proposal includes the support components.",
            hu="Így van: Finnország a szerkezetet tanárpolitikával kötötte össze — ez a csomagolás melletti érv, nem a szelekció megtartása melletti; javaslatunk tartalmazza a támogató elemeket.",
            outcome="maintain")),
}
...
ARGUMENT_CLUSTERS = [
    dict(id="A1", scenario="S3", kind="fact", side="con",
         ...
         raised_by=["pedagogus_erdekvedo", "pdsz", "digitalisgazdasagi"],
    ...
    dict(id="A2", scenario="S3", kind="fact", side="pro",
         ...
         raised_by=["eselyegyenlosegi_civil", "ckp_tanitanek", "egyensuly_intezet"],
    ...
    dict(id="A4", scenario="S2", kind="fact", side="con",
         ...
         raised_by=["egyhazi_fenntartoi", "konzervativ_ertekvedo", "pdsz"],
    ...
    dict(id="A5", scenario="S4", kind="mixed", side="pro",
         ...
         raised_by=["digitalisgazdasagi", "tisza_kormany"],
    ...
    dict(id="A6", scenario="S1", kind="value", side="pro",
         ...
         raised_by=["tisza_kormany", "pdsz", "pedagogus_erdekvedo"],
    ...
    dict(id="A7", scenario="S1", kind="fact", side="con",
         ...
         raised_by=["eselyegyenlosegi_civil", "ckp_tanitanek"],
    ...
    dict(id="A9", scenario="S2", kind="value", side="conditional",
         ...
         raised_by=["pedagogus_erdekvedo", "pdsz"],
    ...
    dict(id="A10", scenario="S4", kind="value", side="con",
         ...
         raised_by=["eselyegyenlosegi_civil", "egyensuly_intezet", "ckp_tanitanek"],
