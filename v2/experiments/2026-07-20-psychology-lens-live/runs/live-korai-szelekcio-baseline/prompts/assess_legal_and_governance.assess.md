...
LENS EVIDENCE:
- F-live-legal_and_governance-01 [strong]: Act CXC of 2011 on National Public Education establishes the statutory framework for 6- and 8-year gimnázium tracks, allowing upper-secondary schools to offer programmes covering grades 5–12 or 7–12 with selection at ages 10–11 or 12–13 respectively.
- F-live-legal_and_governance-02 [strong]: Entrance examinations to 6- and 8-year gimnáziums are centrally organized, creating a legal tension between a centrally administered exam gate and a statutory free-choice regime guaranteed for all students by Act CXC.
- F-live-legal_and_governance-03 [strong]: Church-maintained and private 6- and 8-year gimnáziums operate outside the Klebelsberg Centre's direct governance authority, meaning national reform of admissions criteria, capacity, or curriculum would require separate negotiation with church and minority maintainers rather than unilateral state decree.
- F-live-legal_and_governance-04 [moderate]: Empirical research using large-scale administrative data finds that attending a high-poverty school in Grade 8 is negatively associated with reading scores and secondary attainment, with no significant association for math scores.
- F-live-legal_and_governance-05 [moderate]: Sociological fieldwork indicates self-exclusion mechanisms among socially disadvantaged families are driven primarily by the decision to enter and remain in the preparation process and parental strategic decisions, rather than by the entrance exams themselves.
- F-live-legal_and_governance-06 [strong]: As of June 2026, Education Minister Lannert Judit explicitly stated that the current admissions system produces significant social selection and places heavy burden on children and families, while denying any proposal for outright abolition and calling for societal dialogue on how the admissions system functions.
- F-live-legal_and_governance-07 [moderate]: A 2026 expert debate cited by Válasz Online estimates elite gimnázium training affects approximately 200 schools and 22,000–25,000 children total, representing roughly 5–7% of secondary school enrollment.
