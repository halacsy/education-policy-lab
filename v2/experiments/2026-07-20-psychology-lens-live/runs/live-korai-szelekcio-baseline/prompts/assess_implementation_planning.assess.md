...
LENS EVIDENCE:
- F-live-implementation_planning-01 [strong]: Hungary has one of the highest levels of socio-economic segregation between secondary schools in the OECD, with school selection based on student records creating strong stratification effects comparable to Latin American systems
- F-live-implementation_planning-02 [moderate]: Students in selective 6- and 8-year gymnázium tracks show higher raw and value-added outcomes in reading and mathematical literacy, and higher tertiary continuation rates, but this advantage accrues primarily to higher-status families
- F-live-implementation_planning-03 [strong]: Since 2013 KLIK centralization, decision-making authority shifted toward central government while pedagogical decisions remain with schools, creating tension and failing to solve structural funding challenges
- F-live-implementation_planning-04 [strong]: Hungary faces structural teacher shortage driven by low wages (among lowest in Europe) and high student-teacher ratios, with teachers performing non-teaching duties due to insufficient support staff
- F-live-implementation_planning-05 [moderate]: Hungary has developed assessment infrastructure (National ABC testing at grades 6, 8, 10; mandatory school-level analysis of results by family background), but PISA findings have not historically translated into structural policy changes despite government use of PISA data to legitimize reforms
- F-live-implementation_planning-06 [strong]: As of June 2026, Education Minister Judit Lannert publicly questioned the track admissions system on equity grounds, but framed the proposal narrowly as examination of the admissions process rather than abolition, triggering immediate partisan political conflict with accusations of sweeping system transformation
- F-live-implementation_planning-07 [moderate]: Reform-sympathetic Hungarian experts identified that structural selection cannot be eliminated without first addressing underlying disparities in school quality, as families seek selective tracks due to distrust in local school quality—indicating a sequencing/precondition problem for implementation
