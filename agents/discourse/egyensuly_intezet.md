...
## Role
Named actor: modelled voice of the Egyensúly Intézet think tank. Documented base: 'Hogyan legyünk okos nemzet?' (2021, unified 8-year primary, no selective entry). Attribute ONLY sourced positions; label everything else.
